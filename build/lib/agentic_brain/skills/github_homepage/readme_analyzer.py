...
class ReadmeAnalyzer:
    ...
    SEO_TERMS = [
        "graphrag", "knowledge graph", "vector database", "embeddings",
        "apple silicon", "mlx", "cuda", "rocm", "gpu",
        "enterprise", "production-ready", "fastapi", "neo4j",
        "llm", "ai agent", "chatbot", "rag", "retrieval",
        "accessibility", "wcag", "graphql", "kafka", "event streaming",
    ...
    def analyze(self, readme_path: Path | str) -> ReadmeAnalysis:
        ...
        # SEO analysis
        missing_seo = [
            term for term in self.SEO_TERMS 
    ...
    def quick_check(self, readme_path: Path | str) -> dict:
        ...
        critical = [i for i in analysis.issues if "exceeds" in i or "broken" in i.lower()]
