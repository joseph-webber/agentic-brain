...
class AudioGenerator:
    ...
    @staticmethod
    def generate_tone(frequency: float, duration_ms: float, sample_rate: int = 16000) -> np.ndarray:
    ...
    @staticmethod
    def generate_speech_like_audio(duration_ms: float, sample_rate: int = 16000) -> np.ndarray:
    ...
    @staticmethod
    def create_test_files(output_dir: str = "/tmp/whisper_benchmark_audio") -> Dict[str, str]:
...
class WhisperModelBenchmark:
    ...
    def __init__(self, output_dir: str = "/Users/joe/brain/agentic-brain/apps/BrainChat/benchmarks"):
    ...
    def benchmark_model(self, model_size: str, audio_file: str, audio_duration_ms: int) -> Optional[WhisperBenchmarkResult]:
        ...
        try:
            ...
            result = WhisperBenchmarkResult(
                ...
                first_token_time_ms=int(first_token_time * 1000) if first_token_time else int(total_time * 1000),
    ...
    def _generate_summary(self) -> Dict:
        ...
        for result in self.results:
            if result.success:
                ...
                summary_by_model[key]["audio_durations"].append(result.audio_duration_ms)
        ...
        for model_size, data in summary_by_model.items():
            ...
            summary[model_size] = {
                ...
                "target_ms": 500 if model_size == "tiny" else 1000 if model_size == "base" else 3000
            }
    ...
    def print_summary(self) -> None:
        ...
        if meets_targets:
            ...
            print(f"  • Recommended (meets target): {best[0].upper()} ({best[1]['avg_time_ms']}ms)")
...
def main():
    ...
    parser.add_argument("--output-dir", default="/Users/joe/brain/agentic-brain/apps/BrainChat/benchmarks",
                       help="Output directory for results")
    parser.add_argument("--no-cleanup", action="store_true", help="Don't delete test audio files")
