...
SWIFT_FILES=(
    ...
    "${SRC_DIR}/BrainChatCoordinator.swift"
    "${SRC_DIR}/BrainChatMain.swift"
    "${SRC_DIR}/ChatViewModel.swift"
    "${SRC_DIR}/Models.swift"
    "${SRC_DIR}/EventTypes.swift"
    "${SRC_DIR}/AgenticBrainIntegration.swift"
    "${SRC_DIR}/AIManager.swift"
    "${SRC_DIR}/CartesiaVoice.swift"
    "${SRC_DIR}/CLIHandler.swift"
    "${SRC_DIR}/CodeAssistant.swift"
    "${SRC_DIR}/CodeSpeaker.swift"
    "${SRC_DIR}/CopilotBridge.swift"
    "${SRC_DIR}/LayeredResponseManager.swift"
    "${SRC_DIR}/LayeredResponseView.swift"
    "${SRC_DIR}/PandaproxyClient.swift"
    "${SRC_DIR}/RedpandaBridge.swift"
    "${SRC_DIR}/ResponseWeavingCoordinator.swift"
    "${SRC_DIR}/ResponseWeavingTypes.swift"
    "${SRC_DIR}/ResponseWeavingView.swift"
    "${SRC_DIR}/SafetyGuard.swift"
    "${SRC_DIR}/ScriptingSupport.swift"
    "${SRC_DIR}/SSEStreamParser.swift"
    "${SRC_DIR}/SystemCommands.swift"
    "${SRC_DIR}/VoiceCodingEngine.swift"
    "${SRC_DIR}/VoiceOutputEngines.swift"
    "${SRC_DIR}/VoiceOutputSelector.swift"
    "${SRC_DIR}/VoiceSelector.swift"
    "${SRC_DIR}/YoloExecutor.swift"
    "${SRC_DIR}/YoloMode.swift"
    "${SRC_DIR}/YoloSession.swift"
    "${SRC_DIR}/Security/SecurityRole.swift"
    "${SRC_DIR}/Security/SecurityGuard.swift"
    "${SRC_DIR}/Security/SecurityManager.swift"
    "${SRC_DIR}/Security/PermissionChecker.swift"
    "${SRC_DIR}/Security/DangerousCommands.swift"
)
