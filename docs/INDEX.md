...
- [JHipster](./integrations/JHIPSTER.md)
- [WordPress](./integrations/WORDPRESS.md)
- [WordPress role mapping](./WORDPRESS_ROLE_MAPPING.md)

## Voice docs

- [Voice system overview](./voice/README.md)
- [Spatial audio](./voice/SPATIAL_AUDIO.md)
- [Streaming](./voice/STREAMING.md)
- [Troubleshooting](./voice/TROUBLESHOOTING.md)
...
The audited API path list is maintained in `API_REFERENCE.md` and `docs/openapi.json`.
