...
class InsightsEngine:
    ...
    def analyze_response_time_trends(
        ...
        return {
            ...
            "avg_overall": sum(d["avg_response_ms"] for d in data_points) / len(data_points) if data_points else 0,
        }
        ...
        if error_patterns and error_patterns[0]["frequency"] > 10:
            ...
            recommendations.append(Recommendation(
                ...
                description=f"The '{top_error['error_type']}' error occurs {top_error['frequency']} times "
                            "in the past {} days. Implement specific handling for this error type.".format(days),
                priority="high",
