...
Supports Jina's multilingual embedding models with support for long documents.
...
class JinaEmbedder(Embedder):
    ...
    - jina-embeddings-v2-base-multilingual (512 dimensions, 92 languages)
    """

    MODEL_DIMENSIONS = {
        "jina-embeddings-v2-base-en": 512,
        "jina-embeddings-v2-small-en": 384,
        "jina-embeddings-v2-base-multilingual": 512,
    ...
    def __init__(
        ...
        Args:
            ...
            task: Task type for optimization
        ...
        if not self.api_key:
            raise ValueError("JINA_API_KEY not provided and not set in environment")

        if model not in self.MODEL_DIMENSIONS:
            raise ValueError(f"Unknown Jina model: {model}")
    ...
    def embed_batch_sync(
        ...
        Jina supports efficient batching.
        """
