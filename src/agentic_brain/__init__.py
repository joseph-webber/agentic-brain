...
_LAZY_EXPORTS = {
    ...
    "get_earcon_player": ("agentic_brain.audio", "get_earcon_player"),
    "get_registry": ("agentic_brain.audio", "get_registry"),
    "get_queue": ("agentic_brain.audio", "get_queue"),
    "earcon": ("agentic_brain.audio", "earcon"),
    ...
    "PromptChain": ("agentic_brain.prompts", "PromptChain"),
    "PromptChainResult": ("agentic_brain.prompts", "PromptChainResult"),
    "PromptChainStep": ("agentic_brain.prompts", "PromptChainStep"),
    "PromptLibrary": ("agentic_brain.prompts", "PromptLibrary"),
    "PromptOptimizer": ("agentic_brain.prompts", "PromptOptimizer"),
    "PromptOptimizationResult": (
        "agentic_brain.prompts",
        "PromptOptimizationResult",
    ),
    "PromptTemplate": ("agentic_brain.prompts", "PromptTemplate"),
    "FewShotCollection": ("agentic_brain.prompts", "FewShotCollection"),
    "FewShotExample": ("agentic_brain.prompts", "FewShotExample"),
