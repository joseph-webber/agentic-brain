...
_LAZY_EXPORTS = {
    ...
    "ServerConfig": ("agentic_brain.mcp.server", "ServerConfig"),
    "create_server": ("agentic_brain.mcp.server", "create_server"),
    # Tool context and tools
    "ToolContext": ("agentic_brain.mcp.tools", "ToolContext"),
    "set_context": ("agentic_brain.mcp.tools", "set_context"),
    "get_context": ("agentic_brain.mcp.tools", "get_context"),
    "get_all_tools": ("agentic_brain.mcp.tools", "get_all_tools"),
    "chat": ("agentic_brain.mcp.tools", "chat"),
    "chat_async": ("agentic_brain.mcp.tools", "chat_async"),
    "chat_stream": ("agentic_brain.mcp.tools", "chat_stream"),
    "create_session": ("agentic_brain.mcp.tools", "create_session"),
    "list_sessions": ("agentic_brain.mcp.tools", "list_sessions"),
    "get_session_history": ("agentic_brain.mcp.tools", "get_session_history"),
    "delete_session": ("agentic_brain.mcp.tools", "delete_session"),
    "search_knowledge": ("agentic_brain.mcp.tools", "search_knowledge"),
    "add_document": ("agentic_brain.mcp.tools", "add_document"),
    "store_memory_tool": ("agentic_brain.mcp.tools", "store_memory"),
    "search_memory_tool": ("agentic_brain.mcp.tools", "search_memory"),
    "get_recent_memories_tool": ("agentic_brain.mcp.tools", "get_recent_memories"),
    "health_check": ("agentic_brain.mcp.tools", "health_check"),
    "get_analytics": ("agentic_brain.mcp.tools", "get_analytics"),
    # MCP Types
    "JSONSchema": ("agentic_brain.mcp.types", "JSONSchema"),
    "JSONSchemaProperty": ("agentic_brain.mcp.types", "JSONSchemaProperty"),
    "JSONSchemaType": ("agentic_brain.mcp.types", "JSONSchemaType"),
    "MCPTool": ("agentic_brain.mcp.types", "MCPTool"),
    "MCPResource": ("agentic_brain.mcp.types", "MCPResource"),
    "MCPResourceContent": ("agentic_brain.mcp.types", "MCPResourceContent"),
    "MCPResourceTemplate": ("agentic_brain.mcp.types", "MCPResourceTemplate"),
    "MCPPrompt": ("agentic_brain.mcp.types", "MCPPrompt"),
    "MCPPromptArgument": ("agentic_brain.mcp.types", "MCPPromptArgument"),
    "MCPPromptMessage": ("agentic_brain.mcp.types", "MCPPromptMessage"),
    "MCPCapabilities": ("agentic_brain.mcp.types", "MCPCapabilities"),
    "MCPRequest": ("agentic_brain.mcp.types", "MCPRequest"),
    "MCPResponse": ("agentic_brain.mcp.types", "MCPResponse"),
    "MCPNotification": ("agentic_brain.mcp.types", "MCPNotification"),
    "MCPErrorCode": ("agentic_brain.mcp.types", "MCPErrorCode"),
    "MCPServerInfo": ("agentic_brain.mcp.types", "MCPServerInfo"),
    "MCPClientInfo": ("agentic_brain.mcp.types", "MCPClientInfo"),
    # MCP Client
    "MCPClient": ("agentic_brain.mcp.client", "MCPClient"),
    "MCPClientConfig": ("agentic_brain.mcp.client", "MCPClientConfig"),
    "MCPClientError": ("agentic_brain.mcp.client", "MCPClientError"),
    "MCPConnectionError": ("agentic_brain.mcp.client", "MCPConnectionError"),
    "MCPTimeoutError": ("agentic_brain.mcp.client", "MCPTimeoutError"),
    "MCPProtocolError": ("agentic_brain.mcp.client", "MCPProtocolError"),
    "MCPTransport": ("agentic_brain.mcp.client", "MCPTransport"),
    "StdioTransport": ("agentic_brain.mcp.client", "StdioTransport"),
    "WebSocketTransport": ("agentic_brain.mcp.client", "WebSocketTransport"),
    "MockTransport": ("agentic_brain.mcp.client", "MockTransport"),
}


def __getattr__(name: str):
    """Lazy-load heavier MCP exports on first access."""
...
def __dir__() -> list[str]:
    """Expose lazy MCP exports to dir() and star imports."""
