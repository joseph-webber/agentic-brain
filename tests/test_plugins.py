...
from agentic_brain.plugins import Plugin, PluginConfig, PluginManager
...
class TestModerationPlugin:
    ...
    def test_moderation_plugin_keyword_filter(self):
        ...
        plugin.on_message("this is a badword", user_id="user1")
    ...
    def test_moderation_plugin_pattern_filter(self):
        ...
        plugin.on_message("spam spam spam", user_id="user1")
        assert "user1" in plugin.get_violations()
    ...
    def test_moderation_plugin_length_filter(self):
        ...
        plugin.on_message("this is a very long message", user_id="user1")
        assert "user1" in plugin.get_violations()
