...
class TestNoVoiceOverlap:
    ...
    async def test_daemon_serializes_queued_items(self):
        ...
        with patch.object(ResilientVoice, "_speak_with_fallbacks", mock_speak_with_fallbacks):
    ...
    async def test_rapid_fire_speak_calls(self):
        ...
        assert max_concurrent == 1, f"Voice overlap! Max concurrent was {max_concurrent}, should be 1"
    ...
    async def test_mode_switch_doesnt_interrupt(self):
        ...
        with patch.object(ResilientVoice, "_speak_with_fallbacks", mock_speak_with_fallbacks):
            ...
            mode_task = asyncio.create_task(ResilientVoice.speak("Switching to work mode"))
