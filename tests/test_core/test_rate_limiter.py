...
class TestProviderQuota:
    ...
    def test_custom_values(self):
        quota = ProviderQuota(name="custom", requests_per_minute=30, concurrent_limit=5)
...
class TestSafeAgentCalculation:
    ...
    def test_calculate_safe_agent_count(self):
        count = calculate_safe_agent_count(
            provider="claude", task_duration_minutes=10, requests_per_agent=20
        )
    ...
    def test_calculate_safe_count_ollama(self):
        count = calculate_safe_agent_count(
            provider="ollama", task_duration_minutes=10, requests_per_agent=20
        )
