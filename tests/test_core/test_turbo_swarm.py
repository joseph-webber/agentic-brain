...
class TestTurboChessSwarm:
    ...
    def test_king_protection(self):
        ...
        tasks = [
            SwarmTask(
                id=str(i), name=f"critical{i}", prompt="Critical", complexity="critical"
            )
            for i in range(10)
        ]
    ...
    def test_mixed_complexity_deployment(self):
        ...
        tasks = [
            ...
            SwarmTask(
                id="4", name="critical", prompt="Critical", complexity="critical"
            ),
        ]
        assignments = swarm.plan_deployment(tasks)
    ...
    def test_priority_ordering(self):
        ...
        tasks = [
            SwarmTask(
                id="1", name="low", prompt="Low", complexity="critical", priority=10
            ),
            SwarmTask(
                id="2", name="high", prompt="High", complexity="critical", priority=1
            ),
        ]
