...
from agentic_brain.cli import create_parser, main, ColoredFormatter
from agentic_brain.cli import commands
...
class TestVersionOutput:
    ...
    def test_version_contains_version_number(self, capsys):
        ...
        assert ("version" in output.lower() or __version__ in output or 
                any(c.isdigit() for c in output))
...
class TestInitCommand:
    ...
    def test_init_creates_directories(self, mock_subprocess, mock_open, mock_mkdir, init_args):
