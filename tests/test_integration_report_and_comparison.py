...
def test_full_integration():
    ...
    ev = RAGEvaluator()
    r1 = ev.evaluate(ds, retrievals=[["c1"],["cX"]], retrieved_scores=[[1.0],[0.1]], generated_answers=["a","x"]).to_dict()
    r2 = ev.evaluate(ds, retrievals=[["c1"],["c2"]], retrieved_scores=[[1.0],[0.9]], generated_answers=["a","b"]).to_dict()
