...
class TestStatsEndpoint:
    ...
    def test_stats_values_are_reasonable(self, client, sessions_dict, session_messages_dict):
        ...
        assert data["total_messages"] == sum(len(msgs) for msgs in session_messages_dict.values())
    ...
    def test_stats_timestamp_is_valid_iso8601(self, client):
        ...
        try:
            ...
            assert False, f"Invalid ISO8601 timestamp: {data['timestamp']}"
...
class TestSessionsEndpoint:
    ...
    def test_sessions_with_messages_count(self, client, sessions_dict, session_messages_dict):
        ...
        message_counts = {
            sid: len(msgs) for sid, msgs in session_messages_dict.items()
        }
...
class TestConfigEndpoint:
    ...
    def test_config_post_endpoint_exists(self, client):
        ...
        response = client.post("/dashboard/api/config", json={"key": "test", "value": "value"})
...
class TestSessionWorkflow:
    ...
    def test_delete_sessions_clears_data(self, client, sessions_dict, session_messages_dict):
