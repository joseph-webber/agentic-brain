...
@mcp.tool()
def memory_recall(
    query: str, top_k: int = 10, category: str = None, min_importance: float = 0.0
) -> dict:
    """
...
@mcp.tool()
def memory_context(task: str, top_k: int = 5) -> dict:
    """
...
def memory_stats() -> dict:
    ...
    return {
        ...
        "neo4j": {"connected": driver is not None, "total_memories": memory_count},
        "event_bus": {"connected": bus is not None},
    }
