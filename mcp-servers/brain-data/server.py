        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "recipient": {
                        "type": "string",
                        "description": "Name of person to message (e.g., 'Steve Taylor')",
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "days": {
                        "type": "integer",
                        "description": "Failures in last N days (default 30)",
                    }
                },
            },
        ),
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "term": {
                        "type": "string",
                        "description": "Search term (typos OK - fuzzy matched)",
                    },
                    "fuzzy_threshold": {
                        "type": "integer",
                        "description": "Fuzzy match threshold 0-100 (default 70)",
                    },
                },
                "required": ["term"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "types": {
                        "type": "string",
                        "description": "Comma-separated types: email,teams,jira,sage",
                    },
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "jql": {
                        "type": "string",
                        "description": "JQL query (e.g., 'assignee = steve.taylor AND status = \"In Progress\"')",
                    },
                    "max_results": {
                        "type": "integer",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "issue_type": {
                        "type": "string",
                        "description": "Bug, Story, or Task (default Bug)",
                    },
                    "priority": {
                        "type": "string",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "comment": {
                        "type": "string",
                        "description": "Comment text (plain text, not ADF)",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "state": {
                        "type": "string",
                        "description": "OPEN, MERGED, DECLINED (default OPEN)",
                    },
                    "author": {
                        "type": "string",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "types": {
                        "type": "string",
                        "description": "Comma-separated: emails,teams,sage,jira",
                    }
                },
                "required": ["types"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "service": {
                        "type": "string",
                        "description": "Service name: jira, bitbucket, outlook, teams, sage, mysql, ssh, neo4j, ebay",
                    },
                    "action": {
                        "type": "string",
                        "description": "Action name: get_ticket, get_pr, get_emails, query, etc.",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "event_type": {
                        "type": "string",
                        "description": "Event type (e.g., 'jira.ticket.created', 'sage.failure.detected')",
                    },
                    "data": {
                        "type": "object",
                        "description": "Event data (key-value pairs)",
                    },
                },
                "required": ["event_type"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "skill": {
                        "type": "string",
                        "description": "Skill name (e.g., review-assassin, cerberus, standup)",
                    },
                    "args": {
                        "type": "string",
                        "description": "Arguments as space-separated string",
                    },
                },
                "required": ["skill"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "workflow": {
                        "type": "string",
                        "description": "Workflow name (e.g., review, check-stale-prs, pre-push, daily-summary)",
                    }
                },
                "required": ["workflow"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "category": {
                        "type": "string",
                        "description": "Category filter (e.g., handlers, tools, automation)",
                    }
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "voice": {
                        "type": "string",
                        "description": "Voice: zara (warm lead), echo (tech expert), sage (wise mentor), spark (hype), ghost (mysterious), nova, rishi, robot, whisper, bells. Default: zara",
                    },
                    "emotion": {
                        "type": "string",
                        "description": "Emotion: neutral, excited, calm, concerned, celebratory, mysterious, urgent. Default: neutral",
                    },
                },
                "required": ["message"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "message": {
                        "type": "string",
                        "description": "Celebration message (default: Great job!)",
                    }
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "sound": {
                        "type": "string",
                        "description": "Sound: hero, glass, ping, funk, basso, purr, pop, tink, submarine, sosumi, blow, bottle, complete, success, warning, error",
                    }
                },
                "required": ["sound"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "bot": {
                        "type": "string",
                        "description": "Bot name (e.g., degen_v3, champion, whale)",
                    },
                    "limit": {
                        "type": "integer",
                    ...
                    "days": {
                        "type": "integer",
                        "description": "Only trades from last N days",
                    },
                },
                "required": ["bot"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "bot": {
                        "type": "string",
                        "description": "Bot name (or 'all' for all bots)",
                    },
                    "days": {
                        "type": "integer",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "days": {
                        "type": "integer",
                        "description": "Days of history to sync (default 30)",
                    }
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "repo_path": {
                        "type": "string",
                        "description": "Path to repository (default: citb-talas)",
                    }
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "ticket": {
                        "type": "string",
                        "description": "JIRA ticket (e.g., SD-1330)",
                    },
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "topic": {
                        "type": "string",
                        "description": "Topic to search for (e.g., 'SD-1330', 'Intacct', 'Steve')",
                    }
                },
                "required": ["topic"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "content": {
                        "type": "string",
                        "description": "Key points to include in comment",
                    },
                    "status": {
                        "type": "string",
                        "description": "Update status: investigating, in_progress, complete, blocked",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "action": {
                        "type": "string",
                        "description": "What to deliver: 'jira', 'pr', 'both'",
                    },
                    "ticket": {"type": "string", "description": "JIRA ticket key"},
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "limit": {
                        "type": "integer",
                        "description": "Max backups to show (default 5)",
                    }
                },
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "action": {
                        "type": "string",
                        "description": "status, branch, commits, diff, stash",
                    }
                },
            },
        ),
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "category": {
                        "type": "string",
                        "description": "paths, links, docker, creds, ssh, find, all",
                    },
                    "search": {
                        "type": "string",
                        "description": "Search term for 'find' category",
                    },
                },
            },
        ),
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "action": {
                        "type": "string",
                        "description": "tickets, entity, deploy, check",
                    },
                    "ticket": {
                        "type": "string",
                        "description": "Ticket key for context lookup",
                    },
                },
            },
        ),
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "action": {
                        "type": "string",
                        "description": "review, principles, patterns, help",
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "action": {
                        "type": "string",
                        "description": "check, steps, env, checklist",
                    },
                },
                "required": ["ticket"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "description": {
                        "type": "string",
                        "description": "What we're currently working on",
                    },
                    "todos": {
                        "type": "array",
                        "description": "List of todo objects with id, title, priority, status",
                    },
                    "blockers": {
                        "type": "array",
                        "description": "List of blocker strings",
                    },
                    "learnings": {
                        "type": "array",
                        "description": "Key things learned this session",
                    },
                    "investigations": {
                        "type": "array",
                        "description": "What was investigated/researched",
                    },
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "topic": {
                        "type": "string",
                        "description": "Topic to search for in emails/Teams",
                    },
                    "days": {
                        "type": "integer",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "id": {
                        "type": "string",
                        "description": "Todo ID (kebab-case, e.g., 'fix-login-bug')",
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "limit": {
                        "type": "integer",
                        "description": "Number of checkpoints to show (default 10)",
                    }
                },
            },
        ),
    ...
    try:
        ...
        if name == "brain_ask":
            ...
            result = get_brain_data().jira(
                status=arguments.get("status"), assignee=arguments.get("assignee")
            )

        elif name == "brain_teams":
            result = get_brain_data().teams(
                contains=arguments.get("contains"), sender=arguments.get("sender")
            )
            ...
            try:
                ...
                result = teams.send_message(
                    recipient=arguments["recipient"], message=arguments["message"]
                )
            ...
            adv = get_neo4j_advanced()
            result = (
                adv.get_timeline(days=days, types=types)
                if hasattr(adv, "get_timeline")
                else {"error": "timeline not implemented"}
            )
            ...
            for t in types:
                if t == "emails":
                    results["emails"] = (
                        neo.sync_emails()
                        if hasattr(neo, "sync_emails")
                        else "not implemented"
                    )
                elif t == "teams":
                    results["teams"] = (
                        neo.sync_teams()
                        if hasattr(neo, "sync_teams")
                        else "not implemented"
                    )
                elif t == "sage":
                    results["sage"] = (
                        neo.sync_sage()
                        if hasattr(neo, "sync_sage")
                        else "not implemented"
                    )
            result = results
        ...
        # ===== JIRA API TOOLS =====
            ...
            result = {
                ...
                "assignee": (
                    ticket.get("fields", {}).get("assignee", {}).get("displayName")
                    if ticket.get("fields", {}).get("assignee")
                    else None
                ),
            ...
            tickets = core.jira.search_tickets(
                jql=arguments["jql"], max_results=arguments.get("max_results", 50)
            )
            result = [
                {
                    "key": t.get("key"),
                    ...
                    "assignee": (
                        t.get("fields", {}).get("assignee", {}).get("displayName")
                        if t.get("fields", {}).get("assignee")
                        else None
                    ),
                }
        ...
        # ===== BITBUCKET API TOOLS =====
            ...
            if author:
                prs = [
                    ...
                    for p in prs
                    if author.lower()
                    in p.get("author", {}).get("display_name", "").lower()
                ]
            ...
            result = {
                "pr_id": arguments["pr_number"],
                "diff_url": diff_url,
                "note": "Use diff_url to fetch full diff",
            }
            ...
            result = {
                "note": "Use get_commits_for_ticket(ticket_key) for ticket-specific commits"
            }
        ...
        # ===== BRAIN HEALTH TOOLS =====
            ...
            metrics = {
                "neo4j": {
                    "pool_size": (
                        neo._pool_size if hasattr(neo, "_pool_size") else "unknown"
                    ),
                    "cache_ttl": (
                        neo._cache_ttl if hasattr(neo, "_cache_ttl") else "unknown"
                    ),
                    "retry_count": (
                        neo._retry_count if hasattr(neo, "_retry_count") else "unknown"
                    ),
                },
                "queries": {
                    "cached_queries": (
                        len(neo._cache._cache)
                        if hasattr(neo, "_cache") and hasattr(neo._cache, "_cache")
                        else 0
                    ),
                },
            }
        ...
        # ===== EVENT TOOLS =====
            ...
            result = {"emitted": event_type, "timestamp": event.timestamp, "data": data}
        ...
        # ===== ORCHESTRATOR TOOLS =====
            ...
            if category:
                result = [
                    {"name": s.get("name"), "path": s.get("path")} for s in skills if s
                ]
            else:
                # Group by category
                ...
                result = {
                    ...
                    "categories": {
                        cat: len(skills)
                        for cat, skills in registry.get("categories", {}).items()
                    },
        ...
        # ===== CORE SPEECH TOOLS =====
            ...
            if get_brain_speech:
                ...
                subprocess.run(
                    ["afplay", f"/System/Library/Sounds/{sound.capitalize()}.aiff"]
                )
            result = {"played": sound}
            ...
            if get_brain_speech:
                speech = get_brain_speech()
                result = {
                    vid: {"name": v.name, "personality": v.personality}
        ...
        # ===== CERBERUS TOOLS =====
            ...
            repo_path = arguments.get(
                "repo_path", os.path.expanduser("~/adept/talas/citb-talas")
            )
            try:
                proc = subprocess.run(
                    [
                        "python3",
                        os.path.expanduser("~/brain/skills/cerberus/cerberus.py"),
                        repo_path,
                    ],
                    capture_output=True,
                    text=True,
            ...
            try:
                ...
                proc = subprocess.run(
                    [
                        "python3",
                        os.path.expanduser(
                            "~/brain/skills/review-assassin/gremlin-checker.py"
                        ),
                        repo_path,
                    ],
                    capture_output=True,
            ...
            try:
                proc = subprocess.run(
                    [
                        "python3",
                        os.path.expanduser(
                            "~/brain/skills/review-assassin/security-scanner.py"
                        ),
                        repo_path,
                    ],
                    capture_output=True,
            ...
            try:
                cmd = [
                    "python3",
                    os.path.expanduser(
                        "~/brain/skills/review-assassin/steve-process-checker.py"
                    ),
                    repo_path,
                ]
                if ticket:
        ...
        # ===== HERMES TOOLS =====
            ...
            results = {"topic": topic, "emails": [], "teams": [], "jira": []}
            ...
            try:
                ...
                """
                emails = get_brain_data().query(
                    email_query.replace("$topic", f"'{topic}'")
                )
            ...
            try:
                ...
                """
                teams = get_brain_data().query(
                    teams_query.replace("$topic", f"'{topic}'")
                )
            ...
            try:
                ...
                """
                jira = get_brain_data().query(
                    jira_query.replace("$topic", f"'{topic}'")
                )
            ...
            results["total_found"] = (
                len(results["emails"]) + len(results["teams"]) + len(results["jira"])
            )
            result = results
...
"""
            result = {"ticket": ticket, "pr_description": pr_description, "ready": True}
            ...
            if action in ["pr", "both"]:
                delivered["pr_note"] = (
                    "PR creation requires manual BitBucket interaction"
                )
        ...
        # ===== NEO4J BACKUP QUICK TOOLS =====
            ...
            try:
                proc = subprocess.run(
                    [
                        "python3",
                        os.path.expanduser(
                            "~/brain/tools/neo4j-backup/neo4j-icloud-backup.py"
                        ),
                        "backup",
                    ],
                    capture_output=True,
            ...
            try:
                ...
                result = {"total": len(lines), "backups": lines[:limit]}
            except Exception as e:
                result = {"error": str(e)}
        ...
        # ===== UAT TOOLS (Steve's Process) =====
            ...
            checker_path = os.path.expanduser(
                "~/brain/skills/review-assassin/uat-checker.py"
            )
        ...
        # ===== SESSION CONTINUITY TOOLS =====
            ...
            continuity_path = os.path.expanduser(
                "~/brain/skills/session-continuity/continuity.py"
            )
            ...
            result = {
                ...
                "message": (
                    "Session state saved to plan.md, SQL, Neo4j, and iCloud"
                    if success
                    else "Save failed"
                ),
            }
            ...
            if recovery:
                result = {
                    ...
                    "uncommitted": recovery.get("git_status", {}).get(
                        "uncommitted_count", 0
                    ),
