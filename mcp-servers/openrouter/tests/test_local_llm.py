...
class TestOllamaService:
    ...
    def test_ollama_running(self):
        ...
        assert result.returncode == 0, "Ollama service not running! Start with: ollama serve"
...
class TestIntegration:
    ...
    def test_brain_context_understanding(self):
        ...
        assert any(word in response.lower() for word in ["joseph", "hello", "hi", "help"])
    ...
    def test_code_understanding(self):
        ...
        assert code == 0
        assert any(word in response.lower() for word in ["print", "hello", "output", "display"])
...
class TestFallback:
    ...
    def test_fallback_context_file_exists(self):
        ...
        context_file = os.path.expanduser("~/.brain-continuity/local-llm-brain-context.md")
