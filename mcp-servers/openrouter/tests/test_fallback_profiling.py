...
MODELS_TO_BENCHMARK = {
    "llama3.2:3b": {"description": "Fast local model", "timeout": 30, "expected_max_latency": 15},
    "llama3.1:8b": {"description": "Quality local model", "timeout": 60, "expected_max_latency": 45},
    "claude-emulator": {"description": "Brain-aware recovery model", "timeout": 180, "expected_max_latency": 120},
}
...
class TestResponseLatency:
    ...
    def test_claude_emulator_latency(self, benchmark):
        ...
        result = benchmark.pedantic(
            ...
            rounds=2,
            iterations=1,
            warmup_rounds=0  # Already warmed up
        )
...
class TestModelComparison:
    ...
    def test_model_comparison_simple(self):
        ...
        assert results["llama3.2:3b"]["within_threshold"], \
    ...
    def test_model_comparison_complex(self):
        ...
        for model, config in MODELS_TO_BENCHMARK.items():
            ...
            results[model] = {
                "latency": elapsed,
                "success": meta["success"],
                "response_quality": len(meta.get("response_length", 0)) > 20 if meta["success"] else False
            }
...
class TestRegressionDetection:
    ...
    def test_generate_full_report(self):
        ...
        for model, data in report["models"].items():
            ...
            print(f"{status} {model}: {data['avg_latency']}s avg (threshold: {data['threshold']}s)")
        print("=" * 60)
