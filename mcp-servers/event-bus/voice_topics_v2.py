#!/usr/bin/env python3
"""
Brain Voice Event System v2 - ENHANCED
=====================================
...
Provides:
- VoiceTopicsV2: Complete registry of all voice event topics
- VoiceEventPublisherV2: Enhanced publisher with conversation & turn-taking
- VoiceEventSubscriberV2: Subscribe with callbacks
...
class VoiceEventPublisherV2:
    ...
    def publish_conversation_started(
        ...
        success = self.bus.emit(VoiceTopicsV2.CONVERSATION_STARTED, event.to_dict())
    ...
    def publish_conversation_turn(
        ...
        success = self.bus.emit(VoiceTopicsV2.CONVERSATION_TURN, event.to_dict())
    ...
    def publish_conversation_ended(
        ...
        success = self.bus.emit(VoiceTopicsV2.CONVERSATION_ENDED, event.to_dict())
        self.current_conversation_id = None
    ...
    def publish_lady_introduced(
        ...
        success = self.bus.emit(VoiceTopicsV2.LADY_INTRODUCED, event.to_dict())
    ...
    def publish_lady_reaction(
        ...
        success = self.bus.emit(VoiceTopicsV2.LADY_REACTION, event.to_dict())
    ...
    def publish_mood_changed(
        ...
        success = self.bus.emit(VoiceTopicsV2.MOOD_CHANGED, event.to_dict())
    ...
    def publish_turn_requested(
        ...
        success = self.bus.emit(VoiceTopicsV2.TURN_REQUESTED, event.to_dict())
    ...
    def publish_turn_granted(
        ...
        success = self.bus.emit(VoiceTopicsV2.TURN_GRANTED, event.to_dict())
    ...
    def publish_turn_released(
        ...
        success = self.bus.emit(VoiceTopicsV2.TURN_RELEASED, event.to_dict())
    ...
    def publish_fallback_local(
        ...
        success = self.bus.emit(VoiceTopicsV2.FALLBACK_LOCAL, event.to_dict())
    ...
    def publish_queue_added(
        ...
        success = self.bus.emit(VoiceTopicsV2.QUEUE_ADDED, event.to_dict())
    ...
    def publish_queue_speaking(
        ...
        success = self.bus.emit(VoiceTopicsV2.QUEUE_SPEAKING, event.to_dict())
    ...
    def publish_queue_empty(
        ...
        success = self.bus.emit(VoiceTopicsV2.QUEUE_EMPTY, event.to_dict())
