#!/usr/bin/env python3
"""
Brain Event Bus MCP Server v2 - VOICE ENHANCED
==============================================

MCP server with UPGRADED voice integration featuring:
...
# Import BOTH voice topics versions for compatibility
try:
...
# Import v2 enhanced voice topics
try:
...
_voice_publisher_v2 = None
_voice_subscriber_v2 = None
...
def get_voice_publisher_v2():
    """Get or create voice event publisher v2."""
    global _voice_publisher_v2
    if _voice_publisher_v2 is None:
        bus = get_bus()
        _voice_publisher_v2 = VoiceEventPublisherV2(bus)
    return _voice_publisher_v2


def get_voice_subscriber_v2():
    """Get or create voice event subscriber v2."""
    global _voice_subscriber_v2
    if _voice_subscriber_v2 is None:
        bus = get_bus()
        _voice_subscriber_v2 = VoiceEventSubscriberV2(bus)
    return _voice_subscriber_v2
...
# ============================================================================
# ENHANCED VOICE TOOLS v2 - NEW FEATURES
# ============================================================================

if VoiceTopicsV2 is not None:
    ...
    def voice_conversation_started(
        ...
        if result.get("success"):
            return {
                ...
                "topic_name": VoiceTopicsV2.CONVERSATION_STARTED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_conversation_turn(
        ...
        if result.get("success"):
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.CONVERSATION_TURN
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_conversation_ended(
        ...
        if result.get("success"):
            return {
                ...
                "reason": reason,
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.CONVERSATION_ENDED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_lady_introduced(
        ...
        if result.get("success"):
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.LADY_INTRODUCED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_lady_reaction(
        ...
        if result.get("success"):
            return {
                ...
                "emotion": emotion,
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.LADY_REACTION
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_mood_changed(
        ...
        if result.get("success"):
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.MOOD_CHANGED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_turn_requested(
        ...
        if result.get("success"):
            return {
                ...
                "priority": priority,
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.TURN_REQUESTED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_turn_granted(
        ...
        if result.get("success"):
            return {
                ...
                "duration_seconds": duration_seconds,
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.TURN_GRANTED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_turn_released(
        ...
        if result.get("success"):
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.TURN_RELEASED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_fallback_local(
        ...
        if result.get("success"):
            ...
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.FALLBACK_LOCAL
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_queue_added(
        ...
        if result.get("success"):
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.QUEUE_ADDED
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_queue_speaking(
        ...
        if result.get("success"):
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.QUEUE_SPEAKING
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_queue_empty(
        ...
        if result.get("success"):
            return {
                ...
                "event_id": result.get("event_id"),
                "topic_name": VoiceTopicsV2.QUEUE_EMPTY
            }
        else:
            return {
                "status": "❌ Failed",
    ...
    def voice_topics_v2_list() -> str:
        ...
        - Voice queue management
        """
        output = """🎤 **Voice Topics v2 - ENHANCED**
...
if __name__ == "__main__":
    print("🧠 Event Bus MCP Server v2 (FastMCP) with ENHANCED voice support starting...")
    mcp.run()
