...
CORE_TOPICS = [
    # Brain/AI topics
    "voice", "memory", "learning", "automation", "agents", "llm", "embeddings", "rag",
    # Work topics  
    "jira", "bitbucket", "code_review", "testing", "deployment", "ci_cd", "github",
    # Communication
    "teams", "email", "notifications", "calendar", "slack",
    # Data
    "neo4j", "redis", "backup", "sync", "analytics", "graph",
    # Accessibility
    "voiceover", "accessibility", "audio", "speech", "tts",
    # Personal
    "health", "trading", "family", "travel", "dooby",
    # Technical
    "python", "swift", "java", "javascript", "api", "mcp",
]

def run_migration():
    driver = GraphDatabase.driver(NEO4J_URI, auth=(NEO4J_USER, NEO4J_PASSWORD))
    stats = {"topics_created": 0, "sessions_linked": 0, "memories_linked": 0, "constraints_created": 0}
